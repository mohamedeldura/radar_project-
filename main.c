...
#define RADAR_RADIUS 30   // Radius of the radar circle
#define CENTER_X 64       // X-coordinate of the center of the screen (assuming 128x64 display)
#define CENTER_Y 32       // Y-coordinate of the center of the screen (assuming 128x64 display)
...
int main(void)
{
  ...
  MX_TIM9_Init();
  /* USER CODE BEGIN 2 */
  OLED_Construct(oled, CHIP_SH_1106, 0, 128, 64);
